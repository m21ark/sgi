...
export class TableStruct extends THREE.Object3D {
  constructor(width, height, depth, material, posToGround) {
    ...
    const TableStruct_legMesh1 = new THREE.Mesh(this.TableStruct_leg, legMaterial);
    const TableStruct_legMesh2 = new THREE.Mesh(this.TableStruct_leg, legMaterial);
    const TableStruct_legMesh3 = new THREE.Mesh(this.TableStruct_leg, legMaterial);
    const TableStruct_legMesh4 = new THREE.Mesh(this.TableStruct_leg, legMaterial);
